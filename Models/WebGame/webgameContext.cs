...
namespace WebGame.Models.WebGame
{
    ...
    public partial class webgameContext : DbContext
    {
        ...
        public virtual DbSet<AttDef> AttDef { get; set; }
        public virtual DbSet<Efmigrationshistory> Efmigrationshistory { get; set; }
        public virtual DbSet<Player> Player { get; set; }
        public virtual DbSet<Playeraccount> Playeraccount { get; set; }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseMySql("data source=localhost;port=3306;database=webgame_DB;user=root;password=WebGame", x => x.ServerVersion("8.0.19-mysql"));
            }
        }
