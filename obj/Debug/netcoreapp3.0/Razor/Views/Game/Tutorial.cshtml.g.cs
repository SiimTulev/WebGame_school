#pragma checksum "C:\Lõputöö\Kood\WebGame_school\Views\Game\Tutorial.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "d8edfc147a41510a0fe95c23016442e41ceed56e"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"d8edfc147a41510a0fe95c23016442e41ceed56e", @"/Views/Game/Tutorial.cshtml")]
    ...
    public class Views_Game_Tutorial : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#nullable restore
#line 1 "C:\Lõputöö\Kood\WebGame_school\Views\Game\Tutorial.cshtml"
...
#nullable restore
#line 9 "C:\Lõputöö\Kood\WebGame_school\Views\Game\Tutorial.cshtml"
...
#nullable restore
#line 13 "C:\Lõputöö\Kood\WebGame_school\Views\Game\Tutorial.cshtml"
...
#nullable disable
#nullable restore
#line 16 "C:\Lõputöö\Kood\WebGame_school\Views\Game\Tutorial.cshtml"
...
#line hidden
#nullable disable
            WriteLiteral("        <h2>How to try out WebGame?</h2>\r\n        <p>First, you need to register an account on this website.</p>\r\n        <p>\r\n            To register, click <span class=\"btn btn-info text-white\">\r\n                ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("a", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "d8edfc147a41510a0fe95c23016442e41ceed56e5128", async() => {
...
#nullable restore
#line 25 "C:\Lõputöö\Kood\WebGame_school\Views\Game\Tutorial.cshtml"
    }
    else
    {
...
");
        ...
        <div class=""space"">
            <p>1. To attack an enemy's base, first click on the tower you want to attack, then the cyan-colored menu opens where you need to press <span class=""btn btn-danger move"">Move</span> button.</p>
            <p>2. When you are on <span class=""btn btn-danger"">CreateArmyMission</span> page, you can choose the tower where you attack from.</p>
            <p>
                3.When you have chosen all the army for attacking the tower you chose, then you have an option to connect the army. 
                Connecting means that the army goes for an attack in the same round. The army, which is closer to the enemy, waits for the friendly army that is farther away. In general, connecting makes the army weaker.
            </p>
            <p>4. After the decision, if you want to connect or not, you press <span class=""btn btn-primary"">Create</span> button.</p>
        </div>
");
            WriteLiteral("        <h2>How to send my army to another tower that I own?</h2>\r\n        <p>Do the same like you are going to attack a tower. Just click the tower where you want to send your army.</p>\r\n");
            WriteLiteral(@"        <h2>How to cancel an attack?</h2>
        <div class=""content-3d CancelArmyMovement"">

            <p>1. To cancel the attack you need to press <span class=""btn-3d red"">Movements</span> button.</p>
            ...
            <p>3. After canceling, you can see on top of the page written with red ""<span style=""color:red; font-size:20px;"">People now:... + Army returning sometime (<a style=""color:black; font-size:15px"">[the amount of army]</a>)</span>"".</p>
        </div>
");
            ...
            WriteLiteral(@"        <h2>What tower defence percentage do?</h2>
        <p>Tower defence shows the bonus strength of the army in the tower.</p>
        <p>
            <b>FOR EXAMPLE:</b> if somebody attacks your tower while you have an army amount <b>1000</b> and Defence level is <b>10</b>.
            <br />
            So enemy attacks with <b>500</b> men, then the actual amount of enemy army equals (<b>500 * 0.9</b>), which equals <b>450</b>.
            <br />
            Then the army amount in your tower after the attack will be <b>1000-450=550</b>.
        </p>
        <p>
            <b>PS</b> If the enemy attacks with a connected army, which is a lot bigger than your army,
            <b>FOR EXAMPLE,</b> your <b>1000</b>, enemy's <b>1500</b>, then a lot of enemy's armies go waste because the defence level subtracts from the enemy army amount.
            <br />
            That gives a nonconnected army advantage, because if the enemy attacks with a separated army,
            <b>FOR EXAMPLE</b>, t");
            WriteLiteral(@"he first amount is <b>1300</b>, then another amount is <b>200</b>, so the second army will not fight, because the first <b>1300</b> already destroyed the tower.
            <b>ALSO, if you are missing Main Base, you can't return your soldiers!</b>
        </p>
");
            WriteLiteral(@"        <h2> What borning percentage do?</h2>
        <p>
            Before the army starts attacking your tower, people will be born.
...
");
            WriteLiteral(@"        <h2>What exactly happens, when both players are ready on a round?</h2>
        ...
        <p>
            ...
            <br />
            2. People will be born depending on the borning percentage level and the amount of army in the tower.
            <br />
            3. Army movements will be done last. First, your army will arrive in your tower, then the enemy's army into your tower.
        </p>
");
#nullable restore
#line 105 "C:\Lõputöö\Kood\WebGame_school\Views\Game\Tutorial.cshtml"
